...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="8" background="<%=path %>/images/tbg.gif">&nbsp;拍卖商品管理&nbsp;</td>
				</tr>
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						<a href="#" onclick="goodsDelByMe(<s:property value="#goods.goodsId"/>)" class="pn-loperator">删除</a>
						&nbsp;&nbsp;&nbsp;
						<a href="#" onclick="jingpaikan(<s:property value="#goods.goodsId"/>)" class="pn-loperator">查看竞拍情况</a>
					</td>
				</tr>
				</s:iterator>
			</table>
